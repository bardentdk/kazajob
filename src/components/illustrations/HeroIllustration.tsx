...
export function HeroIllustration() {
  return (
    <div
      className="relative w-[520px] h-[480px] rounded-2xl border-[1.5px] border-[#1A1410] overflow-hidden animate-float"
    ...
    >
      ...
      <div
        className="absolute top-20 left-8 w-[220px] p-3.5 rounded-[10px] border-[1.5px] border-[#1A1410]"
      ...
      <div
        className="absolute top-[265px] right-8 w-[200px] p-3 rounded-[10px] border-[1.5px] border-[#1A1410]"
      ...
      {/* Bulle BD */}
      <div
        className="absolute bottom-3 right-32 px-3.5 py-2.5 rounded-2xl border-[1.5px] border-[#1A1410] text-sm font-bold text-[#1A1410]"

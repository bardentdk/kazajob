...
const ROADMAP = [
  {
    ...
    items: [
      ...
      'CV Builder visuel + export PDF, ou upload de CV',
      'Matching IA avec score de correspondance',
      'Onboarding gamifié + avatar builder',
      'Quiz de personnalité candidat (archétypes)',
      'Messagerie candidat ↔ recruteur + notifications',
      'KazaScore recruteur (réactivité publique)',
      'Pitch vidéo & KazaBoost (mise en avant profil)',
      'KazaEvents, formations & parrainage',
      'Espace recruteur multi-équipe (rôles & invitations)',
    ],
  },
  {
    ...
    status: 'soon',
    items: [
      'Paiement & abonnement en ligne (Stripe)',
      'Plafonds de forfait & gestion fine des accès',
      'Analytics recruteur avancés + exports',
      'Multi-diffusion France Travail',
      'Alertes emploi push (PWA)',

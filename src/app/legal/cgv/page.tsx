  ...
  return (
    <LegalDoc title="Conditions Générales de Vente" updated="11 juin 2026"
      ...
      sections={[
        ...
        { h: '3 bis. Campagnes de lancement (offre gratuite temporaire)', body: [
          'Kazajob peut ouvrir, à sa discrétion et de façon ponctuelle, des campagnes de lancement offrant un accès gratuit temporaire à la publication d\'offres et/ou de formations, distinct des forfaits payants. Le nom, la durée et les limites (nombre d\'offres/formations actives) de chaque campagne sont communiqués au recruteur au moment de son inscription à la campagne.',
          'Une campagne de lancement ne nécessite aucune carte bancaire et ne déclenche aucun prélèvement automatique, ni pendant ni à l\'issue de la période gratuite. À l\'expiration de son accès, la publication et la réactivation d\'offres/formations sont suspendues jusqu\'au choix d\'un forfait payant ; les candidatures et données déjà enregistrées restent accessibles en consultation.',
          'Une entreprise ne peut bénéficier qu\'une seule fois d\'une même campagne. La disponibilité des campagnes de lancement pour les nouvelles inscriptions peut être suspendue ou retirée à tout moment, à la discrétion de Kazajob. L\'activation d\'une campagne ne transforme jamais automatiquement le compte en abonnement payant : toute souscription payante nécessite une action et un consentement explicites du recruteur.',
        ] },

  ...
  return (
    <LegalDoc title="Conditions Générales de Vente" updated="11 juin 2026"
      ...
      sections={[
        ...
        { h: '3. Essai gratuit', body: ['Chaque forfait inclut un essai gratuit de 30 jours. Un moyen de paiement est enregistré à la souscription (via Stripe) ; aucun débit n\'intervient pendant l\'essai. À l\'issue des 30 jours, l\'abonnement est automatiquement débité selon le forfait choisi, sauf résiliation avant la fin de l\'essai.'] },

  ...
  return (
    <div className="min-h-screen grid grid-cols-2" style={{ background: KZ.cream }} >
      ...
      <div className="relative overflow-hidden border-r border-[#1A1410]">
        ...
        />
        {/* Overlay couleur violet semi-transparent */}
        <div
        ...
        <div className="relative z-10 h-full p-8 flex flex-col">
          ...
          {/* Éléments décoratifs SVG au-dessus de l'image */}
      ...
      <div className="flex flex-col justify-center px-16 py-14" style={{ background: KZ.cream }}>
        <h2 className="text-[28px] font-extrabold tracking-tight mb-2 text-[#1A1410]">Connecte-toi</h2>
        <p className="text-sm text-[#6B5A4A] mb-7">
          Pas encore inscrit ?{' '}
          <Link href="/auth/register" className="font-bold" style={{ color: KZ.orange }}>
            Creer un compte
          </Link>
        </p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex justify-between items-center -mt-1">
            <label className="flex items-center gap-2 text-sm text-[#2A2018] cursor-pointer">
              <div className="w-4.5 h-4.5 rounded border border-[#1A1410] bg-[#1A1410] flex items-center justify-center">
                <svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke="#FFF7EE" strokeWidth="2">
                  <path d="M2 6 L5 9 L10 3" />
                </svg>
              </div>
              Rester connecte
            </label>
            <Link href="/auth/forgot" className="text-sm font-semibold" style={{ color: KZ.orange }}>
              Mot de passe oublie ?
            </Link>
          </div>
        ...
        <div className="flex items-center gap-3 my-5 text-xs text-[#6B5A4A]">
          <div className="flex-1 h-px bg-[#E8DDC9]" />
          ou
          <div className="flex-1 h-px bg-[#E8DDC9]" />
        </div>
